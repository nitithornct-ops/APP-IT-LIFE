...
const REQUIRED_COLUMNS = {
  tickets: [
    ...
    'assignee_name_snapshot', 'asset_name_snapshot', 'is_security', 'incident_id', 'due_at', 'outsource_name',
    'location', 'updated_at', 'resolved_at', 'closed_at', 'rating',
  ...
  incidents: ['incident_number', 'severity', 'status', 'contains_personal_data', 'dpo_notify_deadline', 'archived_at', 'archived_by', 'archive_reason'],
  change_requests: ['change_number', 'status', 'archived_at', 'archived_by', 'archive_reason'],
  problems: [
    'problem_number', 'title', 'status', 'priority', 'owner_id', 'root_cause', 'workaround', 'permanent_fix',
    'rca_method', 'five_why', 'fishbone', 'recurrence_count', 'review_meeting_at', 'review_meeting_owner_id',
    'review_meeting_notes', 'change_verified_at', 'change_verified_by', 'change_verification_notes',
  ],
  known_errors: ['known_error_number', 'problem_id', 'title', 'symptoms', 'root_cause', 'workaround', 'affected_versions', 'fixed_version', 'knowledge_article_ref', 'status', 'review_date', 'notes'],
  knowledge_articles: ['article_code', 'title', 'symptom', 'solution', 'tags', 'status', 'author_id', 'published_at', 'created_by', 'updated_by', 'source_known_error_id'],
  problem_configuration_items: ['problem_id', 'ci_id', 'created_by'],
  problem_changes: ['problem_id', 'change_id', 'created_by'],
  problem_corrective_actions: ['id', 'problem_id', 'title', 'description', 'owner_id', 'due_date', 'status', 'completed_at', 'verification_notes', 'created_by', 'updated_by'],
  workflow_definitions: ['workflow_code', 'status', 'archived_at', 'archived_by', 'archive_reason'],
  workflow_instances: ['instance_code', 'status', 'archived_at', 'archived_by', 'archive_reason'],
  backup_logs: ['backup_code', 'archived_at', 'archived_by', 'archive_reason'],
  recovery_tests: ['recovery_code', 'archived_at', 'archived_by', 'archive_reason'],
  bcp_plans: ['plan_code', 'archived_at', 'archived_by', 'archive_reason'],
