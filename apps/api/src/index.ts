...
import { accessControlItemsRoute, accessRegistryRoute, accessRequestsRoute } from './routes/accessRequests';
import { approvalGroupsRoute } from './routes/approvalGroups';
import { accessGroupsRoute } from './routes/accessGroups';
...
import { accessCertificationCampaignsRoute } from './routes/accessCertificationCampaigns';
...
import { systemStatusRoute } from './routes/systemStatus';
...
import { masterDataRegistryRoute } from './routes/masterDataRegistry';
...
app.route('/api/v1/system-status', systemStatusRoute);
...
app.route('/api/v1/access-groups', accessGroupsRoute);
...
app.route('/api/v1/master-data', masterDataRegistryRoute);
...
app.route('/api/v1/access-control-items', accessControlItemsRoute);
app.route('/api/v1/access-requests', accessRequestsRoute);
app.route('/api/v1/access-registry', accessRegistryRoute);
app.route('/api/v1/access-registry/campaigns', accessCertificationCampaignsRoute);
