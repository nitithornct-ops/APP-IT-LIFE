...
export function ChangesPage() {
  ...
  return <div className="flex flex-col gap-4" data-testid="changes-page">
    ...
    {showCreate && (references.isLoading ? <Loader2 className="mx-auto h-5 w-5 animate-spin" /> : references.data && <CreateChangeForm references={references.data} onClose={() => setShowCreate(false)} />)}
