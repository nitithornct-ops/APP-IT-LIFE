...
function useToggleStatus(resource: 'ticket-categories' | 'asset-categories', queryKey: string[]) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="-mt-2 text-sm text-slate-500 dark:text-slate-400">
        หมวดหมู่กลางที่โมดูล Ticket และ Asset (Phase 6 ลำดับถัดไป) จะอ้างอิงต่อ
      </p>
